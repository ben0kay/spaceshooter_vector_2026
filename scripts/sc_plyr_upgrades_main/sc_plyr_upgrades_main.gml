...
/// @description Returns the complete universal four-direction player upgrade tree.
function sc_player_upgrades_get()
{
    static _upgrades = array_concat(
        sc_player_upgrades_weapons_get(),
        sc_player_upgrades_defence_get(),
        sc_player_upgrades_systems_get(),
        sc_player_upgrades_mobility_get(),
        sc_player_upgrades_hybrid_get()
    );
