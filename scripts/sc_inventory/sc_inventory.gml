...
function sc_inventory_selected_drop(_hud)
{
    ...
    var _pickup = sc_resource_pickup_spawn(
        ...
        _removed.key,
        _removed.amount,
        { lifetime_multiplier: GCFG.asteroid.pickup.player_drop_lifetime_multiplier 
			},
		_removed.grade
    );
...
function sc_inventory_statistics_name_get(_category,_key)
{
    ...
    switch (_category)
    {
        ...
        case "kills_by_grade":
            return string_upper(sc_item_grade_name_get(_value));
    ...
    return string_upper(string_replace_all(_key,"_"," "));
}
...
function sc_inventory_draw(_hud)
{
    ...
    switch (_runtime.tab)
    {
        ...
        case InventoryTab.STATISTICS:
            sc_inventory_statistics_draw(_hud,_x,_y);
        break;
...
function sc_inventory_equipment_draw(_hud, _origin_x, _origin_y)
{
	...
	sc_inventory_module_replace_draw(_hud, _origin_x, _origin_y);
