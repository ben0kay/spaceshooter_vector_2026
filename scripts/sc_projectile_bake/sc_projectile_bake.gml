/// @description Bakes every registered projectile visual once during startup.
...
/// @description Deletes all generated projectile sprites.
function sc_projectile_visual_cache_destroy()
{
    if (!variable_global_exists("projectile_visual_cache")) return;
