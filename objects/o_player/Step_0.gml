...
{
    case PlayerState.ACTIVE: sc_player_update_active(id); break;
    case PlayerState.INVENTORY: sc_player_combat_permission_update(id); break;
    case PlayerState.DASHING: sc_player_update_dashing(id); break;
    case PlayerState.STUNNED: sc_player_update_stunned(id); break;
    case PlayerState.DISABLED: sc_player_update_disabled(id); break;
    case PlayerState.DESTROYED: sc_player_update_destroyed(id); break;
}
